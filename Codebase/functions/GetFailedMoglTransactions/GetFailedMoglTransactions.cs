...
namespace functions
{
    public static class GetFailedMoglTransactions
    {
        [FunctionName("GetFailedMoglTransactions")]
            ...
            ILogger log)
        {
            ...
            var client = new RestClient(string.Format("https://www.mogl.com/invoice/{0}.csv", invoice));
            ...
            request.AddHeader("Referer", string.Format("https://www.mogl.com/invoice/{0}.csv", invoice));
